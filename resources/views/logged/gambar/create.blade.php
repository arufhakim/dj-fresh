...
<div class="card">
    <div class="card-header pb-0">
        <h6 class="mb-0">Tambah Gambar</h6>
    </div>
    <div class="card-body pb-0">
        <form action="{{route('gambar.store')}}" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                <label for="gambar" class="form-control-label">Gambar<span class="required">*</span></label>
                <input class="form-control form-control-sm @error('gambar') is-invalid @enderror" id="gambar" name="gambar" type="file">
