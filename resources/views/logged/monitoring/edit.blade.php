...
@section('body')
    <div class="card">
        <div class="card-header pb-0">
            <h6 class="mb-0">Edit Monitoring</h6>
        </div>
            ...
            <form action="{{ route('monitoring.update', ['monitoring' => $monitoring->id]) }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm @error('area') is-invalid @enderror" type="text"
                        id="area" name="area" value="{{ old('area') ?? $monitoring->area }}">
                    @error('area')
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm @error('pic') is-invalid @enderror" type="text"
                        id="pic" name="pic" value="{{ old('pic') ?? $monitoring->pic }}">
                    @error('pic')
                        <div class="invalid-feedback mt-0">
                            <small>{{ $message }}</small>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm @error('auditor') is-invalid @enderror" type="text"
                        id="auditor" name="auditor" value="{{ old('auditor') ?? $monitoring->auditor }}">
                    @error('auditor')
                        <div class="invalid-feedback mt-0">
                            <small>{{ $message }}</small>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <select class="form-control form-control-sm @error('kondisi') is-invalid @enderror" id="kondisi"
                        name="kondisi">
                        <option value=''></option>
                        <option value="Baik" @if (old('kondisi', $monitoring->kondisi) == 'Baik') selected @endif>Baik</option>
                        <option value="Cukup" @if (old('kondisi', $monitoring->kondisi) == 'Cukup') selected @endif>Cukup</option>
                        <option value="Kurang" @if (old('kondisi', $monitoring->kondisi) == 'Kurang') selected @endif>Kurang</option>
                    </select>
                    @error('kondisi')
                        <div class="invalid-feedback mt-0">
                            <small>{{ $message }}</small>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm @error('tanggal') is-invalid @enderror" type="date"
                        id="tanggal" name="tanggal" value="{{ old('tanggal') ?? $monitoring->tanggal }}">
                    @error('tanggal')
                        <div class="invalid-feedback mt-0">
                            <small>{{ $message }}</small>
                        </div>
                ...
                <div class="form-group">
                    ...
                    <input class="form-control form-control-sm @error('keterangan') is-invalid @enderror" type="text"
                        id="keterangan" name="keterangan" value="{{ old('keterangan') ?? $monitoring->keterangan }}">
                    @error('keterangan')
                        <div class="invalid-feedback mt-0">
                            <small>{{ $message }}</small>
                        </div>
