    ...
    <div class="card-header bg-khaki pb-0">
        <div class="row">
            ...
            <div class="col-6 text-end">
                <a class="btn btn-xs btn-primary mb-0" href="{{route('video.create')}}"><i class="fas fa-plus"></i>&nbsp;&nbsp;Tambah</a>
            </div>
        </div>
    </div>
                ...
                <table id="table" class="table align-items-center mb-4 datatable">
                    <thead>
                        <tr>
                            ...
                            <th class="text-uppercase text-secondary text-xxs font-weight-bolder text-center" style="width: 50%;">Video Preview</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="align-middle text-center">
                                <span class="text-xs forestgreen font-weight-bold">{{$vid->nama}}</span>
                            </td>
                            <td class="align-middle text-center">
                                <video class="custom-rounded" width="300px" height="auto" controls>
                                    <source src="video-upload/{{$vid->video}}" type="video/mp4">
                            ...
                            <td class="align-middle text-center">
                                <form action="{{route('video.destroy', ['video' => $vid->id])}}" method="POST" style="display:inline">
                                    @csrf
                                    @method('DELETE')
                                ...
                                <a class="btn btn-link text-dark py-0 px-1 my-0" href="{{route('video.edit', ['video' => $vid->id])}}"><i class="fas fa-pencil-alt text-dark" aria-hidden="true"></i></a>
                            </td>
                        </tr>
                        @endforeach
                    </tbody>
